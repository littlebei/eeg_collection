...
#define DEVICE_NAME                     "EEG_DETECTION"                           /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME               "CHERBURIMIND"                       /**< Manufacturer. Will be passed to Device Information Service. */
